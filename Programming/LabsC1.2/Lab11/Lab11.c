...
int main() {
    ...
    // Если встречается хотя бы один числовой файл и хотя бы один текстовый файл, выводим "alphanumeric"
    if ((numericCount > 0 && alphabeticFilePrinted) || (numericCount > 0 && alphanumericFilePrinted) || (numericCount > 0 && alphabeticFilePrinted)) {
        printf("Processing alphanumeric file...\n");
    }
